...
// Removed for Panopus - stub PDF/OCR functions:
const extractPdfText = async (_path: string): Promise<string> => "";
const extractImageText = async (_path: string): Promise<string> => "";
