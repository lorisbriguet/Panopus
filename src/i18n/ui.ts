...
const ui = {
  en: {
    ...
    columns_two: "2 columns",
    columns_three: "3 columns",
  ...
  fr: {
    ...
    columns_one: "1 colonne",
    columns_two: "2 colonnes",
    columns_three: "3 colonnes",
    ...
    rename_tag: "Renommer l'etiquette",
    change_tag_color: "Changer la couleur",
    delete_tag: "Supprimer l'etiquette",
    confirm_delete_tag: "Supprimer ?",
    no_tags_yet: "Aucune etiquette",
    bulk_tag_menu: "Etiqueter",
